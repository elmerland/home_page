	...
	<article class="main">
		<div class="content">
			<header>
				...
				<p><time pubdate datetime="2014-01-04">Created on: January 4, 2014</time></p>
			...
			<section id="TheFinalResult">
				...
				<p>
					<a title="Snake project" href="../projects/snake/snake.html" target="_blank">../projects/snake/snake.html</a>
				</p>
			</section>
			<section id="TheCode">
				<header>
			...
			<section id="TheMakingOf">
				...
				<section id="HTML">
					<header>
						<h2>HTML</h2>
						<a href="#HTML"><img src="../_images/link20.png"></a>
						<a class="toTop" href="#"><img src="../_images/toTop.png"></a>
					</header>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_1.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_2.php"); ?></pre>
					<p>
				...
				<section id="JavaScripttable">
					...
					<pre data-highlight=""><?php include("../_code/snake_game_5.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_6.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_7.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_8.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_9.php"); ?></pre>
					<p>
				...
				<section id="JavaScriptSnake">
					<header>
						<h2>JavaScript - Snake</h2>
						<a href="#JavaScriptSnake"><img src="../_images/link20.png"></a>
						<a class="toTop" href="#"><img src="../_images/toTop.png"></a>
					</header>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_10.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_11.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_12.php"); ?></pre>
					<p>
						Now we will concern ourselves with how the snake actually moves. First lets take a look at the play function.
					</p>
					<pre data-highlight=""><?php include("../_code/snake_game_13.php"); ?></pre>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_14.php"); ?></pre>
					<p>
						Lastly lets dissect the <strong>moveSnake()</strong> function, that is in charge of moving the snake head node.
					</p>
					<pre data-highlight=""><?php include("../_code/snake_game_15.php"); ?></pre>
					<p>
				...
				<section id="CSS">
					<header>
						<h2>CSS</h2>
						<a href="#CSS"><img src="../_images/link20.png"></a>
						<a class="toTop" href="#"><img src="../_images/toTop.png"></a>
					</header>
					<p>
					...
					<pre data-highlight=""><?php include("../_code/snake_game_16.php"); ?></pre>
				</section>
			</section>
			...
			<footer>
				<p>
					...
					Las updated: January 6, 2014<br><br>
			...
			<section>
				...
				<ul>
					...
					<ul>
						...
						<a href="#JavaScripttable"><li>JavaScript - table</li></a>
						<a href="#JavaScriptSnake"><li>JavaScript - Snake</li></a>
