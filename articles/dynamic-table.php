...
<head>
	...
	?>
	<title>Creating a Dynamically Sized Table with JavaScript</title>
</head>
<body>
	<?php
	...
	<article class="main">
		...
		<div id="outline">
			<section>
				<h2>Creating a Dynamically Sized Table with JavaScript - Outline</h2>
				<ul>
