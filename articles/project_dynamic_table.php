	...
	<article class="main">
		...
		<div class="content">
			...
			<section id="theCode">
				...
				<br>
				<br>
					<a title="table.html" href="../projects/dynamic_table/table.html" target="_blank">
						HTML - table.html
					</a><br>
					
					<a title="main.css" href="../projects/dynamic_table/css/main.css" target="_blank">
						CSS - main.css
					</a><br>
					
					<a title="table.js" href="../projects/dynamic_table/js/table.js" target="_blank">
						JavaScript - table.js
					</a><br>
				</p>
			</section>
