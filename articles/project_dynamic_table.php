	...
	<article class="main">
		<div class="content">
			...
			<section id="TheMakingOf">
				...
				<section id="Step1HTML">
					<header>
						<h2>Step 1 - HTML</h2>
						<a href="#Step1HTML"><img src="../_images/link20.png"></a>
						<a class="toTop" href="#"><img src="../_images/toTop.png"></a>
					</header>
					<p>
					...
					<p>
						<pre><?php include("../_code/dynamic_table_1.php") ?></pre>
					</p>
				</section>
				<section id="Step2JavaScript">
					<header>
						<h2>Step 2 - JavaScript</h2>
						<a href="#Step2JavaScript"><img src="../_images/link20.png"></a>
						<a class="toTop" href="#"><img src="../_images/toTop.png"></a>
					</header>
					<p>
		...
		<nav class="outline float">
			<section>
				...
				<ul>
					...
					<ul>
						<a href="#Step1HTML"><li>Step 1 - HTML</li></a>
						<a href="#Step2JavaScript"><li>Step 2 - JavaScript</li></a>
					</ul>
